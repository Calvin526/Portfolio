...
function App() {
  ...
  <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
    ...
    <div>
      <a href="/Calvin_Garcia_Resume.pdf" class="inline-block text-lg px-6 py-3 leading-none border rounded text-white border-white hover:border-transparent hover:text-purple-500 hover:bg-white mt-4 lg:mt-0"  target="_blank" rel="noopener noreferrer"> View Resume</a>
    </div>
  </div>
</nav>
